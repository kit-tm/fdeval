...
Edited by Robert Bauer (2019): made some small changes to make this compatible with python 3 (xrange, iter.next)
"""
...
def build_vert(vl):
    v_id, v_name, v_lat, v_long, v_country = None, None, None, None, None
    ...
    return (v_id, v_name, v_lat, v_long, v_country)
...
def deserialize(d, **kw):
    ...
    serial = iter(range(0, 2 ** 62)).__next__
    verts, edges = [], []
