...
class gen_pbce2(object):
    # same as PBCE but you can specify a source array where sources occur multiple times
    ...
    def __init__(self, ctx, generator, **kwargs):
        ...
        fg_random_sources = kwargs.get("fg_random_sources")
        ...
        for i, epoch in enumerate(fg_epoch):
            ...
            for i in range(math.floor(1000/reduce_scale*epoch)):
                ...
                label_src = random.choice(fg_random_sources)
                label_dst = label_src
